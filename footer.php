    ...
    <footer class="bg-dark text-center text-white text-lg-start border pb-4">
        ...
        <div class="container text-center text-md-start mt-2 pt-3">
            <div class="row mt-3">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-3" id="hi">
                    ...
                    <a href="cust_login.php"  class="text-white text-decoration-none text-nowrap">Customer Login</a><br>
        ...
        <div class="text-center pt-2 mt-2">
            <img src="image/apu_logo_horizontal_white.png" width="272px", height="88px"><br><br>
