<?php 
    ...
    {
        $sql = 
        "SELECT product.ProductID, product.ProductName, product.Price, product.ProductPicture, product.SubCategoryID
        FROM product INNER JOIN subcategory ON product.SubCategoryID = subcategory.SubCategoryID
    ...
    {
        $sql = 
        "SELECT ProductID, ProductName, Price, ProductPicture, SubCategoryID
    ...
    if ($result ->num_rows === 0)
    {
        ...
        while ($row=mysqli_fetch_array($result))
        {
            ...
            <div class="card shadow-sm me-4 mb-4 " style="width:250px; height: 370px; min-width:250px"">
                <a href="seller_products_info.php?ProductID='.$row["ProductID"].'" class="text-decoration-none on-hover-darken">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fs-4 px-3 py-3 '.print_categoryIcon($con, $row["SubCategoryID"]).'"></span>
                        </div>
                    </div>
                </a>
            </div>';
